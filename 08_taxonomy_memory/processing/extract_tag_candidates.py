...
def main() -> None:
    ...
    p.add_argument("--output-l2", default="08_taxonomy_memory/step_results/learning_queue_l2.jsonl")
    p.add_argument("--output-l3", default="08_taxonomy_memory/step_results/learning_queue_l3.jsonl")

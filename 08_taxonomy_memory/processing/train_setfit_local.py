...
def main() -> None:
    ...
    p.add_argument("--train-jsonl", default="08_taxonomy_memory/step_results/domain_taxonomy_learned.jsonl")
    p.add_argument("--output-dir", default="08_taxonomy_memory/models/setfit_local")

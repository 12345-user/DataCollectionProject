...
def main() -> None:
    ...
    p.add_argument("--queue-l2", default="05_domain_analysis/step_results/learning_queue_l2.jsonl")
    p.add_argument("--queue-l3", default="05_domain_analysis/step_results/learning_queue_l3.jsonl")
    p.add_argument("--learned-l2", default="05_domain_analysis/step_results/learned_l2.jsonl")
    p.add_argument("--learned-l3", default="05_domain_analysis/step_results/learned_l3.jsonl")
    ...
    p.add_argument(
        "--stopwords-zh",
        default="05_domain_analysis/config/stopwords_zh.yaml",
        help="Chinese stopwords yaml (default: 05_domain_analysis/config/stopwords_zh.yaml)",
    )
    p.add_argument(
        "--professional-lexicon",
        default="05_domain_analysis/config/professional_tag_lexicon.yaml",

...
_DEFAULT_CFG = Path("05_domain_analysis/config/tag_taxonomy_3layer.yaml")
_DEFAULT_LEARNED_L2 = Path("05_domain_analysis/step_results/learned_l2.jsonl")
_DEFAULT_LEARNED_L3 = Path("05_domain_analysis/step_results/learned_l3.jsonl")
_DEFAULT_STOPWORDS = Path("05_domain_analysis/config/stopwords_zh.yaml")
_DEFAULT_MESH_LEXICON = Path("05_domain_analysis/resources/mesh/mesh_terms.jsonl")
_DEFAULT_MESH_MAPPING = Path("05_domain_analysis/config/mesh_mapping.yaml")
_DEFAULT_PRO_LEXICON = Path("05_domain_analysis/config/professional_tag_lexicon.yaml")

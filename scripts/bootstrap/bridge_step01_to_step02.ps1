...
$srcAbstractsJsonl = "01_data_collection/step_results/professor_paper_abstracts/$OutputPrefix`_abstracts.jsonl"
$srcLab = "01_data_collection/step_results/professor_lab_info/$OutputPrefix`_lab_info.json"

$targetDir = "02_paper_list_extend/data_sources/from_step01/$OutputPrefix"
...
if (Test-Path $srcAbstractsJsonl) { Copy-Item -Force $srcAbstractsJsonl "$targetDir/abstracts.jsonl" }

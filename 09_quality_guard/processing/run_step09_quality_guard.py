...
def main() -> None:
    p = argparse.ArgumentParser(description="Step09 quality guard: integrity, linkage, dirty-data, readability checks.")
    ...
    files = {
        ...
        "step03": Path(f"04_author_disambiguation/step_results/{prefix}_step03_disambiguated_papers.jsonl"),
        "step04": Path(f"05_keyword_entity/step_results/{prefix}_step04_keyword_entity.jsonl"),
        "step05_paper": Path(f"06_domain_clustering/step_results/{prefix}_step05_paper_domains.jsonl"),
        "step05_domain": Path(f"06_domain_clustering/step_results/{prefix}_step05_domains.json"),
        "step06_timeline": Path(f"07_temporal_analysis/step_results/{prefix}_step06_project_timeline.json"),
        "step06_alloc": Path(f"07_temporal_analysis/step_results/{prefix}_step06_effort_allocation.json"),
        "step06_report": Path(f"07_temporal_analysis/step_results/{prefix}_step06_trend_report.md"),
    }
